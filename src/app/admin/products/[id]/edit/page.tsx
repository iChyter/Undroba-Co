...
const mockProduct: Product = {
  ...
  description: 'Hoodie oversize de algodón premium con capucha ajustable.',
  price: 85000,
  category: 'hoodies',
  sizes: ['S', 'M', 'L', 'XL'],
...
export default function EditProduct({ params }: { params: { id: string } }) {
  ...
  const [sizes, setSizes] = useState<string[]>(mockProduct.sizes);
  const [colors, setColors] = useState<string[]>(mockProduct.colors);
